...
public class HelloController {
	...
	@RequestMapping(path="/hello")  //query string method
	public String hello(@RequestParam("name")String name,
		...
		@RequestMapping(path = "/hi/{name}/{id}")  //path param method
		public String hi(@PathVariable("name") String name,@PathVariable("id") int id ,
